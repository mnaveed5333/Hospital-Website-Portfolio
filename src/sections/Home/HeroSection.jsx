        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 sm:gap-12 lg:gap-16">
          ...
          <div className="flex-1 text-center lg:text-left space-y-6 sm:space-y-8">
            ...
            <div className="inline-flex items-center gap-2 bg-green-50 border border-green-200 rounded-full px-3 sm:px-4 py-2">
              <FaAward className="text-green-600" size={14} />
              <span className="text-green-700 font-medium text-xs sm:text-sm">Most Trusted Healthcare in Pakistan</span>
            </div>
            ...
            <div className="space-y-2 sm:space-y-3">
              {features.map((feature, index) => (
                <div key={index} className="flex items-center gap-2 sm:gap-3 text-gray-700">
                  <feature.icon className="text-green-600 flex-shrink-0" size={18} />
          ...
          <div className="flex-1 relative w-full max-w-sm sm:max-w-md lg:max-w-xl cursor-pointer" onClick={() => navigate('/doctors')}>
            {/* Background Gradient Circle */}
            <div className="absolute inset-0 flex justify-center items-center">
              <div className="w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 rounded-full bg-gradient-to-br from-cyan-100 to-green-100 z-0 animate-pulse-slow" />
            </div>
